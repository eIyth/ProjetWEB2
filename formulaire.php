...
function afficheProduitParMarque(){
 ...
 // CNX BDD + REQUETE pour obtenir les marques correspondantes à des produits
    ...
    ?>
    <form class ="mb-4 mt-4" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <fieldset>
...
function afficheFormModifier($donne){
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-8">
            <div class="card mt-4">
                <img style="margin:auto" class="miniature" src="images/outils/<?php echo $tab_info["Image"]; ?>" alt="image">
                <div class="card-body">
